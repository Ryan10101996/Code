...
class list
  {
    ...
    void PRINT_BY_MAJOR(string fileline) //Prints by major
    {
        ...
        {
            temp=head;
            for(int y=listlength-1-i;y>0;y--)
            {
                temp=temp->next;
            }
    ...
    void PRINT_BY_GPA(string fileline)
    {
        ...
        {
            temp=head;
            for(int y=listlength-i-1;y>0;y--)
            {
                 temp=temp->next;//WRites stuff...
            }
            cout << temp->info.info5 << endl;
                ...
                if(fileline!="")
                    {
                        ...
                        if(x==6)
                        {
                            if(linkedlist.duplicates(information))  //if it makes it allll the way through it checks for duplicates
                                linkedlist.createnode(information); //and if there are none it stores
                        }
                    }
                else
                    break;
...
template<class Type>
void list<Type>::createnode(Type information)       //This creates my createnode function. He doesn't behave well with the rest of the functions
